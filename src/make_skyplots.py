...
from astrometry_equations import error_ellipses, compute_error_normalized_distance
...
def main():
    ...
    xm = np.load('../results/final_crossmatch_10as_all_neighbours.npy')[:100]
    ...
    for i in range(len(uniques)):
        ...
        for j, idx in enumerate(gaia_idxs):
            ...
            ax.scatter(g_ra-h_ra, g_dec-h_dec, c=f'C{j}', label=f'Gaia {gaia["source_id"]}', s=15)   
